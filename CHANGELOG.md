...
---------------------------------------
- 2021.2.23 Chg: [Chg] 一键安装脚本中，增加了判题机的自启动服务的安装
- 2021.2.21 Chg: [Chg] 更新了一键安装脚本，支持Ubuntu与CentOS 7.X/8.X的安装
- 2021.2.20 Chg: [Bug] 修复 PHP 7.4 环境下部分操作报内部错误的问题
- 2021.2.20 Chg: [Bug] 修复一键安装后，添加参赛用户与小组邀请成员会出现用户不存在的情况
- 2021.2.20 Chg: [Bug] 修复创建小组后，显示错误不能进入的BUG

- 2021.1.17 Chg: [Bug] 修复测试点详情转义问题
- 2021.1.12 Chg: [Enh] 小组成员列表中，增加了解题数量，默认从高到低排列，可点击“角色”与“通过数”切换排序
...
- 2020.11.16 Chg: [Enh] 小组作业与后台比赛创建时，增加了指定编程语言的选项，可以强制指定比赛的编程语言

- 2020.10.25 Chg: [web] 调整用户登录加密参数，默认加密时用户登录需要0.5秒验证计算，调整后速度会快很多
- 2020.10.25 Chg: [Enh] 私有(VIP)题目绿色显示，后台增加普通用户是否显示私有题目的选项
- 2020.10.25 Chg: [web] KindEditor图片上传模式调整
- 2020.10.25 Bug: [web] 修复Markdown编辑器的图片上传功能
- 2020.10.25 Bug: [web] 在CentOS 8中运行Python出错的处理
- 2020.10.25 Chg: [Enh] 增加提交间隔时间的功能与后台选项

- 2020.10.20 Chg: [web] 对部分未汉化的地方进行了汉化
- 2020.10.20 Chg: [Enh] 后台加入小组密码与昵称重置的选项，以及组长直接拉成员的选项
- 2020.10.20 Chg: [web] 题目页面，时间限制与在内存限制位置调整，优化显示
- 2020.10.20 Chg: [Enh] 比赛与小组作业添加题目时，增加了同时添加多个题目的支持
- 2020.10.20 Chg: [Enh] 批量创建用户时，增加用户名/昵称/密码模式
