    ...
    <div class="row">
        <div class="col-lg-2">
            <?= $form->field($model, 'problem_id', [
                'template' => "{label}\n<div class=\"input-group\"><span class=\"input-group-addon\"><span class='glyphicon glyphicon-book'></span></span>{input}</div>",
        ...
        <?= $form->field($model, 'result', [
            'template' => "{label}\n<div class=\"input-group  btn-group-justified\"><span class=\"input-group-addon\">" . Yii::t('app', 'Result') . "</span>{input}</div>",
        ])->dropDownList($model::getResultList())->label(false) ?>
        </div>
        <div class="col-lg-3">
        <?= $form->field($model, 'language', [
            'template' => "{label}\n<div class=\"input-group  btn-group-justified\"><span class=\"input-group-addon\">" . Yii::t('app', 'Lang') . "</span>{input}</div>",
