        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($problems as $key => $p) : ?>
                    <tr>
                        <th><?= Html::a('P' . ($key + 1),  ['/contest/problem', 'id' => $model->id, 'pid' => $key, '#' => 'problem-anchor'],['target'=>'_blank']) ?></th>
                        <th><?= Html::a($p['problem_id'], ['/p/'.$p['problem_id']],['target'=>'_blank']) ?></th>
                        <td><?= Html::a(Html::encode($p['title']),  ['/contest/problem', 'id' => $model->id, 'pid' => $key, '#' => 'problem-anchor'],['target'=>'_blank']) ?></td>
                        <th>
