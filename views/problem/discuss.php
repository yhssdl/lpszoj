            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr>
                    ...
                    <td width="auto" valign="middle">
                        ...
                        <small style="color: #aaa">
                            ...
                            <time title="<?= Yii::t('app', 'Last Reply Time') ?>">
                                <span class="fa fa-clock-o"></span> <?= Yii::$app->formatter->asRelativeTime($discuss->updated_at)?>
                            </time>
                    ...
                    <td width="50" align="right" valign="middle" title="<?= Yii::t('app', 'Reply') ?>">
                        <?= Html::a('<span class="fa fa-comment"></span> ', ['/discuss/view', 'id' => $discuss->id], ['class' => 'badge']); ?>
                    </td>
                </tr>
                </tbody>
            </table>
