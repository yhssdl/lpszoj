...
<div class="problem-create">
    ...
    <i class="glyphicon glyphicon-info-sign"></i> 感谢您参与 信息技术 &amp; 人工智能 公共题库的建设！下面两栏请任选一项填写，重复同步同一题目仅做强制覆盖不会另外新建题目。
    </div>
    <?= Html::beginForm() ?>
    <div class="form-group animate__animated animate__fadeInUp">
        ...
        <p class="help-block"><i class="glyphicon glyphicon-info-sign"></i> 请提供位于 <?= Html::a(Yii::t('app', 'Polygon System'), ['/polygon/problem']) ?> 问题对应 ID</p>
    </div>
    ...
    <div class="form-group animate__animated animate__fadeInUp">
        ...
        <p class="help-block"><i class="glyphicon glyphicon-info-sign"></i> 请提供位于 <?= Html::a(Yii::t('app', 'Polygon System'), ['/polygon/problem']) ?> 问题对应 ID 的范围</p>
    </div>
