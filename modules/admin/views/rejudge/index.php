...
<div class="contest-form animate__animated animate__fadeInUp">
    ...
    <div class="alert alert-light"><i class="fa fa-info-circle"></i> 重判该题号的所有提交记录。</div>
    ...
    <div class="alert alert-light"><i class="fa fa-info-circle"></i> 重判该场比赛的所有提交记录。</div>
    ...
    <div class="alert alert-light"><i class="fa fa-info-circle"></i> 重判该提交记录。</div>
